...
module.exports = "<div class=\"col-md-12 pt-4\" style=\"text-align: center;\">\r\n    <div class =\"breadcrumb\"><a [href]=\"['/categories']\">Subjects</a><span style=\"color:#007BFF\"> > </span> <a [href]=\"subc\">  Levels</a><span style=\"color:#007BFF\"> > </span> <a [href]=\"top\">  Topics</a><span style=\"color:#007BFF\"> > </span> <a [href]=\"subtop\">  Sub-Topics</a> <span style=\"color:#007BFF\"> > </span> <a [href]=\"resource\">  Resources</a> </div>\r\n</div>\r\n<div *ngIf=\"!modal\">\r\n    <div>\r\n        <div class=\"col-md-4\">\r\n            <a class=\"pointer\" (click)=\"layoutChange(1)\"><img\r\n              *ngIf='!empty'     src=\"https://img.icons8.com/ios-filled/30/000000/activity-grid--v2.png\"></a>\r\n            <a class=\"pointer\" (click)=\"layoutChange(2)\"><img\r\n              *ngIf='!empty'     src=\"https://img.icons8.com/material-two-tone/40/000000/day-view.png\"></a>\r\n        </div>\r\n    </div>\r\n\r\n    <div *ngIf='list'>\r\n        <div class=\"container-fulid pt-2\" *ngFor='let resource of data' >\r\n            <div class=\"row\" style=\"text-align: center;\">\r\n                <div class=\"col-md-7 offset-md-1 grey_title pb-1\"\r\n                    style=\"background-color: #1d8459; border: 1px solid black\">\r\n                    <div class=\"pt-2\" id=\"Title\">\r\n                        <h5>{{resource.resource_type}}</h5> <div class=\"text-right\">{{resource.created | date:medium}}</div>\r\n                        <br>\r\n                        <div style=\"background: white;text-transform: lowercase;\">\r\n                          <a *ngIf=\"www(resource.link)\" [href]=\"'//' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n                          <a *ngIf=\"http(resource.link)\" [href]=\"'' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n                        </div>\r\n                      </div>\r\n                    <div class=\"d-flex\" style=\"text-align: center;\">\r\n                      <br>\r\n                        <p class=\"pt-3 pl-3\" id=\"Description\" style=\"text-align: center;\"><b>{{resource.description}}</b></p>\r\n                    </div>\r\n                    <button class=\"btn btn-secondary text-white float-right\" (click)=\"resourceDetails(resource)\">more\r\n                        Details</button>\r\n                </div>\r\n                <div class=\"col-md-3 pl-5\">\r\n                    <div class=\"d-flex\">\r\n                        <div class=\"d-flex flex-column\">\r\n                            <a class=\"pointer\" (click)=\"saveLink(resource.id)\"><img src=\"assets/images/Plus.png\"\r\n                                    width=\"55px\" title=\"Save This\"></a>\r\n                            <star-rating [value]=\"resource.avg_rating\" checkedcolor=\"red\" uncheckedcolor=\"black\"\r\n                                size=\"24px\" readonly=\"true\"></star-rating>\r\n                                <a class=\"pointer\" (click)=\"followAuther(resource.author)\"><img\r\n                                  src=\"assets/images/Profile.png\" width=\"60px\" title=\"Follow Author\"></a>\r\n                                <p (ngInit)=\"getname()\">{{username}}a</p>\r\n                                </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"col-12 pt-5\">\r\n                <div class=\"d-flex collapse\" *ngFor=\"let comment of resource.fewComment\">\r\n                    <div class=\"col-md-1 offset-md-1\">\r\n                        <div class=\"d-flex pic_padding\">\r\n                            <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                        <div class=\"d-flex flex-column\">\r\n                            <h4>{{comment.commenter_name}}\r\n                                <star-rating [value]=\"getRating(comment.commenter,resource.id)\" checkedcolor=\"red\"\r\n                                    uncheckedcolor=\"black\" size=\"24px\" readonly=\"true\"></star-rating>\r\n                            </h4>\r\n                            <p class=\"pt-2\">{{comment.comment}}</p>\r\n                            <span class=\"data\"\r\n                                style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{comment.created | date:medium}}</span>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <!-- <div class=\"d-flex collapse\" *ngFor=\"let rate of onlyRating\">\r\n                <div class=\"col-md-1 offset-md-1\">\r\n                    <div class=\"d-flex pic_padding\">\r\n                        <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <h4>{{rate.rated_by_name}}\r\n                            <star-rating [value]=\"rate.rating\" checkedcolor=\"red\" uncheckedcolor=\"black\" size=\"24px\" readonly=\"true\"></star-rating>\r\n                        </h4>\r\n                        <p class=\"pt-2\"></p>\r\n                        <span class=\"data\" style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{rate.created | date:medium}}</span>\r\n                    </div>\r\n                </div>\r\n            </div> -->\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div class=\"container-fulid pt-2\" *ngIf='!list'>\r\n        <div class=\"row\" style=\"text-align: center;\">\r\n            <div class=\"col-md-3 pb-3\" *ngFor='let resource of data'>\r\n                <div class=\"card\" style=\"text-align: center;\">\r\n                    <h5 class=\"card-title pt-2 text-capitalize\" style=\"text-align: center;\">{{resource.resource_type}}\r\n                    </h5>\r\n                    <div class=\"card-body\">\r\n                      <div style=\"background: grey;text-align: center;text-transform: lowercase;\">\r\n                        <a *ngIf=\"www(resource.link)\" [href]=\"'//' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n                        <a *ngIf=\"http(resource.link)\" [href]=\"'' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n                      </div>                        <p class=\"card-text\" style=\"text-align: center;\">{{resource.description}}</p>\r\n                        <p class=\"text-center\">\r\n                            <star-rating [value]=\"resource.avg_rating\" checkedcolor=\"red\" uncheckedcolor=\"black\"\r\n                                size=\"24px\" readonly=\"true\"></star-rating>\r\n                        </p>\r\n                        <button class=\"btn btn-secondary text-white btn-block\" (click)=\"resourceDetails(resource)\">more\r\n                            Details</button>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"not_found\" *ngIf='empty'>\r\n        <img src=\"assets/images/not-found.png\" alt=\"\">\r\n    </div>\r\n</div>\r\n\r\n\r\n<div *ngIf=\"modal\">\r\n    <div class=\"container-fulid pt-2\">\r\n        <div class=\"row\"  style=\"text-align: center;\">\r\n            <strong class=\"pointer pl-3\" (click)=\"hideModal()\">〈 Back</strong>\r\n            <div class=\"col-md-7 offset-md-1 grey_title pb-1\"\r\n                style=\"background-color: #1d8459; border: 1px solid black\">\r\n                <div class=\"pt-2\" id=\"Title\">\r\n                    <h5>{{modelData.resource_type}}</h5> <div class=\"text-right\">{{modelData.created | date:medium}}</div>\r\n                    <br>\r\n                    <div style=\"background: white;text-transform: lowercase;\">\r\n                      <a *ngIf=\"www(modelData.link)\" [href]=\"'//' + modelData.link\"  target=\"_blank\" style=\"color:black\">{{modelData.link}}</a>\r\n                      <a *ngIf=\"http(modelData.link)\" [href]=\"'' + modelData.link\"  target=\"_blank\" style=\"color:black\">{{modelData.link}}</a>                        </div>                </div>\r\n                <div class=\"d-flex\">\r\n                    <p class=\"pt-3 pl-3\" id=\"Description\"><b>{{modelData.description}}</b></p>\r\n                </div>\r\n            </div>\r\n            <div class=\"col-md-3 pl-5\">\r\n                <div class=\"d-flex\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <a class=\"pointer\" (click)=\"saveLink(modelData.id)\"><img src=\"assets/images/Plus.png\"\r\n                                width=\"55px\" title=\"Save This\"></a>\r\n                        <star-rating [value]=\"modelData.avg_rating\" checkedcolor=\"red\" uncheckedcolor=\"black\"\r\n                            size=\"24px\" readonly=\"true\"></star-rating>\r\n                            <a class=\"pointer\" (click)=\"followAuther(modelData.author)\"><img\r\n                              src=\"assets/images/Profile.png\" width=\"60px\" title=\"Follow Author\"></a>\r\n\r\n                            </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n        <div class=\"col-12 pt-5\">\r\n            <div class=\"d-flex collapse\" *ngFor=\"let comment of modelData.comments\">\r\n                <div class=\"col-md-1 offset-md-1\">\r\n                    <div class=\"d-flex pic_padding\">\r\n                        <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <h4>{{comment.commenter_name}}\r\n                            <star-rating [value]=\"getRating(comment.commenter,modelData.id)\" checkedcolor=\"red\"\r\n                                uncheckedcolor=\"black\" size=\"24px\" readonly=\"true\"></star-rating>\r\n                        </h4>\r\n                        <p class=\"pt-2\">{{comment.comment}}</p>\r\n                        <span class=\"data\"\r\n                            style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{comment.created | date:medium}}</span>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"d-flex collapse\" *ngFor=\"let rate of onlyRating\">\r\n                <div class=\"col-md-1 offset-md-1\">\r\n                    <div class=\"d-flex pic_padding\">\r\n                        <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <h4>{{rate.rated_by_name}}\r\n                            <star-rating [value]=\"rate.rating\" checkedcolor=\"red\" uncheckedcolor=\"black\" size=\"24px\"\r\n                                readonly=\"true\"></star-rating>\r\n                        </h4>\r\n                        <p class=\"pt-2\"></p>\r\n                        <span class=\"data\"\r\n                            style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{rate.created | date:medium}}</span>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"row py-4\"  >\r\n            <div class=\"col-md-7 offset-md-2\">\r\n                <form [formGroup]='rateCommentForm' (ngSubmit)=\"ratingHandler()\">\r\n                    <h5>Write a Review about this Post</h5>\r\n                    <div class=\"form-group\">\r\n                        <label>Rate This Link</label><br>\r\n                        <star-rating [value]=\"rate\" checkedcolor=\"red\" uncheckedcolor=\"black\" size=\"24px\"\r\n                            readonly=\"false\" (rate)=\"onRate($event)\"></star-rating>\r\n                    </div>\r\n                    <div class=\"form-group\">\r\n                        <label>Comment : </label>\r\n                        <textarea class=\"form-control\" formControlName=\"comment\"\r\n                            placeholder=\"Enter Your Comment Here\"></textarea>\r\n                    </div>\r\n                    <button type=\"submit\" class=\"btn btn-success\">Submit</button>\r\n                    <button class=\"btn btn-secondary ml-2\" (click)=\"hideModal()\">Cancel</button>\r\n                </form>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n"
...
var ResourceComponent = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        data.subscribe(function (res) {
                            ...
                            var _loop_2 = function (i) {
                                _this.onlyRating2 = _this.ratings.filter(function (r) { return r.rated_by == _this.comments[i].commenter; });
                            };
                            for (var i = 0; i < _this.data.length; i++) {
                                _loop_2(i);
                            }
                            console.log(_this.onlyRating2);
                            ...
                            _this.onlyRating.sort(function (a, b) {
    ...
    ResourceComponent.prototype.getname = function () {
        alert('adad');
    };
...
module.exports = "<div *ngIf=\"!modal\">\r\n    <div>\r\n        <div class=\"col-md-4\">\r\n            <a  *ngIf='!empty' class=\"pointer\" (click)=\"layoutChange(1)\"><img\r\n                    src=\"https://img.icons8.com/ios-filled/30/000000/activity-grid--v2.png\"></a>\r\n            <a *ngIf='!empty' class=\"pointer\" (click)=\"layoutChange(2)\"><img\r\n                    src=\"https://img.icons8.com/material-two-tone/40/000000/day-view.png\"></a>\r\n        </div>\r\n    </div>\r\n\r\n    <div *ngIf='list'>\r\n        <div class=\"container-fulid pt-2\" *ngFor='let resource of data'>\r\n            <div class=\"row\"  style=\"text-align: center;\">\r\n                <div class=\"col-md-7 offset-md-1 grey_title pb-1\"\r\n                    style=\"background-color: #1d8459; border: 1px solid black\">\r\n                    <div class=\"pt-2\" id=\"Title\">\r\n                        <h5 class=\"text-center text-white text-capitalize\">{{resource.resource_type}}</h5><div class=\"text-right\">{{resource.created | date:medium}}</div>\r\n                        <br>\r\n                        <div style=\"background: white;text-transform: lowercase;\">\r\n                          <a *ngIf=\"www(resource.link)\" [href]=\"'//' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n                          <a *ngIf=\"http(resource.link)\" [href]=\"'' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>                      </div>\r\n                      </div>\r\n                    <div class=\"d-flex\">\r\n                        <p class=\"pt-3 pl-3 text-white\" id=\"Description\"><b>{{resource.description}}</b></p>\r\n                    </div>\r\n                    <button class=\"btn btn-secondary text-white float-right\" (click)=\"resourceDetails(resource)\">more\r\n                        Details</button>\r\n                </div>\r\n                <div class=\"col-md-3 pl-5\">\r\n                    <div class=\"d-flex\">\r\n                        <div class=\"d-flex flex-column\">\r\n                            <a class=\"pointer\" (click)=\"saveLink(resource.id)\"><img src=\"assets/images/Plus.png\"\r\n                                    width=\"55px\" title=\"Save This\"></a>\r\n                            <star-rating [value]=\"resource.avg_rating\" checkedcolor=\"red\" uncheckedcolor=\"black\"\r\n                                size=\"24px\" readonly=\"true\"></star-rating>\r\n                                <a class=\"pointer\" (click)=\"followAuther(resource.author)\"><img\r\n                                  src=\"assets/images/Profile.png\" width=\"60px\" title=\"Follow Author\"></a>                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"col-12 pt-5\">\r\n                <div class=\"d-flex collapse\" *ngFor=\"let comment of resource.fewComment\">\r\n                    <div class=\"col-md-1 offset-md-1\">\r\n                        <div class=\"d-flex pic_padding\">\r\n                            <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                        <div class=\"d-flex flex-column\">\r\n                            <h4>{{comment.commenter_name}}\r\n                                <star-rating [value]=\"getRating(comment.commenter,resource.id)\" checkedcolor=\"red\"\r\n                                    uncheckedcolor=\"black\" size=\"24px\" readonly=\"true\"></star-rating>\r\n                            </h4>\r\n                            <p class=\"pt-2\">{{comment.comment}}</p>\r\n                            <span class=\"data\"\r\n                                style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{comment.created | date:medium}}</span>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <!-- <div class=\"d-flex collapse\" *ngFor=\"let rate of onlyRating\">\r\n                <div class=\"col-md-1 offset-md-1\">\r\n                    <div class=\"d-flex pic_padding\">\r\n                        <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <h4>{{rate.rated_by_name}}\r\n                            <star-rating [value]=\"rate.rating\" checkedcolor=\"red\" uncheckedcolor=\"black\" size=\"24px\" readonly=\"true\"></star-rating>\r\n                        </h4>\r\n                        <p class=\"pt-2\"></p>\r\n                        <span class=\"data\" style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{rate.created | date:medium}}</span>\r\n                    </div>\r\n                </div>\r\n            </div> -->\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div class=\"container-fulid pt-2\" *ngIf='!list'>\r\n        <div class=\"row\"  style=\"text-align: center;\">\r\n            <div class=\"col-md-3 pb-3\" *ngFor='let resource of data'>\r\n                <div class=\"card\">\r\n                    <h5 class=\"card-title pt-2 text-white text-capitalize\" style=\"text-align: center;\">{{resource.resource_type}}\r\n                    </h5>\r\n                    <div class=\"card-body\">\r\n                      <div style=\"background: grey;text-align: center;text-transform: lowercase;\">\r\n                        <a *ngIf=\"www(resource.link)\" [href]=\"'//' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n                        <a *ngIf=\"http(resource.link)\" [href]=\"'' + resource.link\"  target=\"_blank\" style=\"color:black\">{{resource.link}}</a>\r\n\r\n                      </div>                        <p class=\"card-text\" style=\"text-align: center;\">{{resource.description}}</p>\r\n                        <p class=\"text-center\">\r\n                            <star-rating [value]=\"resource.avg_rating\" checkedcolor=\"red\" uncheckedcolor=\"black\"\r\n                                size=\"24px\" readonly=\"true\"></star-rating>\r\n                        </p>\r\n                        <button class=\"btn btn-secondary text-white btn-block\" (click)=\"resourceDetails(resource)\">more\r\n                            Details</button>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"not_found\" *ngIf='empty'>\r\n        <img src=\"assets/images/not-found.png\" alt=\"\">\r\n    </div>\r\n  </div>\r\n\r\n\r\n  <div *ngIf=\"modal\">\r\n    <div class=\"container-fulid pt-2\">\r\n        <div class=\"row\"  style=\"text-align: center;\">\r\n            <strong class=\"pointer pl-3\" (click)=\"hideModal()\">〈 Back</strong>\r\n            <div class=\"col-md-7 offset-md-1 grey_title pb-1\"\r\n                style=\"background-color: #1d8459; border: 1px solid black\">\r\n                <div class=\"pt-2\" id=\"Title\">\r\n                    <h5 class=\"text-center text-white text-capitalize\">{{modelData.resource_type}}</h5><div class=\"text-right\">{{modelData.created | date:medium}}</div>\r\n                    <br>\r\n                    <div style=\"background: white;text-transform: lowercase;\">\r\n                      <a *ngIf=\"www(modelData.link)\" [href]=\"'//' + modelData.link\"  target=\"_blank\" style=\"color:black\">{{modelData.link}}</a>\r\n                      <a *ngIf=\"http(modelData.link)\" [href]=\"'' + modelData.link\"  target=\"_blank\" style=\"color:black\">{{modelData.link}}</a>                    </div>               </div>\r\n                <div class=\"d-flex\">\r\n                    <p class=\"pt-3 pl-3\" id=\"Description\"><b>{{modelData.description}}</b></p>\r\n                </div>\r\n            </div>\r\n            <div class=\"col-md-3 pl-5\">\r\n                <div class=\"d-flex\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <a class=\"pointer\" (click)=\"saveLink(modelData.id)\"><img src=\"assets/images/Plus.png\"\r\n                                width=\"55px\" title=\"Save This\"></a>\r\n                        <star-rating [value]=\"modelData.avg_rating\" checkedcolor=\"red\" uncheckedcolor=\"black\"\r\n                            size=\"24px\" readonly=\"true\"></star-rating>\r\n                            <a class=\"pointer\" (click)=\"followAuther(modelData.author)\"><img\r\n                              src=\"assets/images/Profile.png\" width=\"60px\" title=\"Follow Author\"></a>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n        <div class=\"col-12 pt-5\">\r\n            <div class=\"d-flex collapse\" *ngFor=\"let comment of modelData.comments\">\r\n                <div class=\"col-md-1 offset-md-1\">\r\n                    <div class=\"d-flex pic_padding\">\r\n                        <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <h4>{{comment.commenter_name}}\r\n                            <star-rating [value]=\"getRating(comment.commenter,modelData.id)\" checkedcolor=\"red\"\r\n                                uncheckedcolor=\"black\" size=\"24px\" readonly=\"true\"></star-rating>\r\n                        </h4>\r\n                        <p class=\"pt-2\">{{comment.comment}}</p>\r\n                        <span class=\"data\"\r\n                            style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{comment.created | date:medium}}</span>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"d-flex collapse\" *ngFor=\"let rate of onlyRating\">\r\n                <div class=\"col-md-1 offset-md-1\">\r\n                    <div class=\"d-flex pic_padding\">\r\n                        <img src=\"assets/images/Author.png\" width=\"50\" style=\"border-radius: 50%\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-md-5 pr-5 pic_padding comment\">\r\n                    <div class=\"d-flex flex-column\">\r\n                        <h4>{{rate.rated_by_name}}\r\n                            <star-rating [value]=\"rate.rating\" checkedcolor=\"red\" uncheckedcolor=\"black\" size=\"24px\"\r\n                                readonly=\"true\"></star-rating>\r\n                        </h4>\r\n                        <p class=\"pt-2\"></p>\r\n                        <span class=\"data\"\r\n                            style=\"font-size: 12px;position: absolute;right: 0;top:10px;\">{{rate.created | date:medium}}</span>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"row py-4\">\r\n            <div class=\"col-md-7 offset-md-2\">\r\n                <form [formGroup]='rateCommentForm' (ngSubmit)=\"ratingHandler()\">\r\n                    <h5>Write a Review about this Post</h5>\r\n                    <div class=\"form-group\">\r\n                        <label>Rate This Link</label><br>\r\n                        <star-rating [value]=\"rate\" checkedcolor=\"red\" uncheckedcolor=\"black\" size=\"24px\"\r\n                            readonly=\"false\" (rate)=\"onRate($event)\"></star-rating>\r\n                    </div>\r\n                    <div class=\"form-group\">\r\n                        <label>Comment : </label>\r\n                        <textarea class=\"form-control\" formControlName=\"comment\"\r\n                            placeholder=\"Enter Your Comment Here\"></textarea>\r\n                    </div>\r\n                    <button type=\"submit\" class=\"btn btn-success\">Submit</button>\r\n                    <button class=\"btn btn-secondary ml-2\" (click)=\"hideModal()\">Cancel</button>\r\n                </form>\r\n            </div>\r\n        </div>\r\n    </div>\r\n  </div>\r\n"
